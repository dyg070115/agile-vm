/*
 *	Agile VM 移动前端MVVM框架
 *	Version	:	0.1.5.1509008397207 beta
 *	Author	:	nandy007
...
(function(){
	...
	var _$ = window.jQuery||__webpack_require__(3), JQLite = _$, jqlite = JQLite;
...
　　 	  },
	...
	jqlite.vm = function(el, data){
		var MVVM = __webpack_require__(5);
...
(function () {
	...
	var Updater = __webpack_require__(7);
	var Watcher = __webpack_require__(8);
